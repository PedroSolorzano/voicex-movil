...
class ChatterboxTtsProvider implements TTSProvider {
  ...
  ChatterboxTtsProvider(String baseUrl, {this.token = ''})
  ...
  static Future<ServerHealth> healthOf(String baseUrl, {String token = ''}) =>
      probeServer(buildUri(baseUrl, '/api/model-info'),
          token: token, engine: 'chatterbox');
  ...
  Future<TTSResult> synthesize({
    ...
    final resp = await req.close().timeout(TtsTimeouts.synthesisChatterbox);
