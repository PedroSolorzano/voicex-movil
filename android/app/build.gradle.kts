...
android {
    ...
    compileOptions {
        // flutter_local_notifications usa java.time para programar los avisos
        // de lectura; en Android anterior al 8 esa API no existe y hay que
        // traerla con desugaring.
